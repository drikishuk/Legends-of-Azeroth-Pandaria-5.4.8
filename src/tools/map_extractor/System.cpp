...
uint32 CONF_TargetBuild = 19099;              // 5.4.8 18273 -- current build is 18414, but Blizz didnt rename the MPQ files
...
char const* CONF_mpq_list[] =
{
    ...
    "expansion3.MPQ",
    "expansion4.MPQ",
    "wow-update-base-19099.MPQ"
};

uint32 const Builds[] = {16016, 16048, 16057, 16309, 16357, 16516, 16650, 16844, 16965, 17116, 17266, 17325, 17345, 17538, 17645, 17688, 17898, 18273, 19099, };
