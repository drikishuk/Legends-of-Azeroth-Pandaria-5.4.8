...
void WorldDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(WORLD_INS_WAYPOINT_DATA, "INSERT INTO waypoint_data (id, point, position_x, position_y, position_z, orientation, delay) VALUES (?, ?, ?, ?, ?, ?, ?)", CONNECTION_ASYNC);
