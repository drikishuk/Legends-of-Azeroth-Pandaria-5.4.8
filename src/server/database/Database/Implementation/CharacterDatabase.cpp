...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_UPD_CHARACTER_FOR_BOOST, "UPDATE characters SET race = ?, money = money + 1000, level = 20, position_x = ?, position_y = ?, position_z = ?, orientation = ?, map = ?, talenttree = ?,"
